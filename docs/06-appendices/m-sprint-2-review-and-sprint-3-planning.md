...
Use this appendix as the formal working record for the closeout of **Sprint 2** and the preparation of **Sprint 3**. It is intended to be completed by the team together with the **Adviser** and **Research Coordinator** after Sprint 2 outputs have been reviewed.

This is a routine sprint-governance record. The **Student Team** owns the sprint work at **Level 0**, while the **Adviser** and **Research Coordinator** provide **Level 1** delivery-support review. The **Teacher** and **Faculty Panel** may inspect this record later as gate evidence, but they are not the normal Sprint 2 approvers.

## A. Sprint 2 Review Record
...
| Expected Sprint 2 Output | Status | Notes / Evidence |
| --- | --- | --- |
| Planned Sprint 2 backlog items were completed or properly carried over. | [ ] Complete [ ] Needs Revision |  |
...
| Recurring Appendix A to F or Epic 4 User Story 1 to 6 evidence was updated for Sprint 2 as applicable. | [ ] Complete [ ] Needs Revision |  |
...
| Appendix Slot | Epic 4 User Story | Chapter 4 Section | Sprint 2 Evidence to Record | Status | Notes / Reference |
| --- | --- | --- | --- | --- | --- |
| A | User Story 1 - Document Scrum Execution Narrative | `a-scrum-execution.md` | Sprint 2 goal, completed stories, blockers, release evidence | [ ] Complete [ ] Partial [ ] Not Applicable |  |
| B | User Story 2 - Report Implemented Features and Outputs | `b-features-and-outputs.md` | Implemented Sprint 2 features, outputs, screenshots, or repository artifacts | [ ] Complete [ ] Partial [ ] Not Applicable |  |
...
| D | User Story 4 - Report System Testing Results | `d-system-testing-results.md` | Executed Sprint 2 test cases, expected versus actual results, defects | [ ] Complete [ ] Partial [ ] Not Applicable |  |
| E | User Story 5 - Report Code Coverage Results | `e-code-coverage-results.md` | Coverage report for Sprint 2 modules or approved exception basis | [ ] Complete [ ] Partial [ ] Not Applicable |  |
...
This section verifies the institutional review responsibilities for Sprint 2.
...
### 5. Sprint 2 Review Summary

#### Accomplishments

List the major outputs completed during Sprint 2.
...
List the items that still need correction before or during Sprint 3.
...
Summarize the retrospective discussion at the end of Sprint 2.
...
- [ ] Sprint 2 outputs are accepted and the team is ready for Sprint 3.
- [ ] Sprint 2 outputs are accepted with minor revisions to be completed during Sprint 3.
- [ ] Sprint 2 outputs require major revision before Sprint 3 work should proceed.

Overall review remarks:


## B. Sprint 3 Planning Record

### 1. Sprint 3 Planning Overview
...
List the user stories or issues approved for Sprint 3. These should come from the prioritized backlog and must be feasible within the planned sprint window.
...
### 5. Sprint 3 Review Responsibility Reminder

For **Sprint 3**, the normal institutional review pattern is as follows:
...
List the issues that may affect Sprint 3 execution and the action to be taken.
...
- Update Appendix A to F or Epic 4 User Story 1 to 6 evidence again in Sprint 3 so Chapter 4 remains traceable by sprint.
...
---
[⬅️ Previous](l-sprint-2-retrospective.md) | [Next ➡️](n-sprint-3-retrospective.md)