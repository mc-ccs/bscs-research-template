# Sprint 3 Review and Final Sprint Planning

Use this appendix as the formal working record for the closeout of **Sprint 3** and the preparation of the **Final Sprint**. It is intended to be completed by the team together with the **Adviser** and **Research Coordinator** after Sprint 3 outputs have been reviewed.

This is a routine sprint-governance record. The **Student Team** owns the sprint work at **Level 0**, while the **Adviser** and **Research Coordinator** provide **Level 1** delivery-support review. The **Teacher** and **Faculty Panel** may inspect this record later as gate evidence, but they are not the normal Sprint 3 approvers.

## A. Sprint 3 Review Record
...
### 2. Sprint 3 Output Completion Checklist

Mark each item after review.

| Expected Sprint 3 Output | Status | Notes / Evidence |
| --- | --- | --- |
| Planned Sprint 3 backlog items were completed or properly carried over. | [ ] Complete [ ] Needs Revision |  |
...
| Recurring Appendix A to F or Epic 4 User Story 1 to 6 evidence was updated for Sprint 3 as applicable. | [ ] Complete [ ] Needs Revision |  |
...
| Appendix Slot | Epic 4 User Story | Chapter 4 Section | Sprint 3 Evidence to Record | Status | Notes / Reference |
| --- | --- | --- | --- | --- | --- |
| A | User Story 1 - Document Scrum Execution Narrative | `a-scrum-execution.md` | Sprint 3 goal, completed stories, blockers, release evidence | [ ] Complete [ ] Partial [ ] Not Applicable |  |
| B | User Story 2 - Report Implemented Features and Outputs | `b-features-and-outputs.md` | Implemented Sprint 3 features, outputs, screenshots, or repository artifacts | [ ] Complete [ ] Partial [ ] Not Applicable |  |
...
| D | User Story 4 - Report System Testing Results | `d-system-testing-results.md` | Executed Sprint 3 test cases, expected versus actual results, defects | [ ] Complete [ ] Partial [ ] Not Applicable |  |
| E | User Story 5 - Report Code Coverage Results | `e-code-coverage-results.md` | Coverage report for Sprint 3 modules or approved exception basis | [ ] Complete [ ] Partial [ ] Not Applicable |  |
...
This section verifies the institutional review responsibilities for Sprint 3.
...
List the items that still need correction before or during the final sprint.
...
Record the main references used during the review.
...
Summarize the retrospective discussion at the end of Sprint 3.
...
| What should the team improve in the final sprint? |  |
...
- [ ] Sprint 3 outputs are accepted and the team is ready for the final sprint.
- [ ] Sprint 3 outputs are accepted with minor revisions to be completed during the final sprint.
- [ ] Sprint 3 outputs require major revision before final sprint work should proceed.

Overall review remarks:


## B. Final Sprint Planning Record

### 1. Final Sprint Planning Overview

| Field | Details |
| --- | --- |
| Planned Sprint | Final Sprint |
| Covered Dates |  |
| Sprint Goal |  |
...
### 2. Final Sprint Planned Backlog

List the user stories or issues approved for the final sprint. These should come from the prioritized backlog and must be feasible within the planned sprint window.
...
| --- | --- |
| Sprint 3 velocity or equivalent baseline used for planning |  |
| Default async update cadence for the sprint (minimum 3 per week) |  |
| Team members available during the final sprint |  |
| Major academic or technical constraints during the final sprint |  |
| Dependencies that must be resolved early in the final sprint |  |

### 4. Final Sprint Definition of Done Reminder

Each approved backlog item for the final sprint must satisfy the following before it is counted as complete.
...
### 5. Final Sprint Review Responsibility Reminder

For the **Final Sprint**, the normal institutional review pattern is as follows:
...
List the issues that may affect final sprint execution and the action to be taken.
